...
| nntrainer | (issue #60) | 8 Elite (Galaxy S25 Ultra) | CPU, `main` | 512 / 1024 / 4096 | pending | pending | **the baseline every nntrainer HVX goal is read against** (user decision 2026-09-18); handoff `docs/measurements/60-cpu-baseline.md` |
