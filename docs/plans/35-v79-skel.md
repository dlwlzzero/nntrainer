...
| G2 | v75 sim unchanged | 13/13 + `profile acc` PASS with every STAT **bit-identical** to §8.3's SDK 6.4 record: `profile_prefill_acc STAT max_abs=0.077216 max_rel=98.2637`, `quant_generic pm1=0/65536`, `quant16_generic pm1=167/25600`, `matmul_w8a8_m8 0.0078125/0.000788644`, `graph` prefill `0.0245416/9.3795` / decode `0.0202219/23.975`, `logits 7.62939e-06/2.36832e-07`. |
