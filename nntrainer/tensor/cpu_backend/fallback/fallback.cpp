...
void quant_w8cx_f32(size_t n, size_t k, void *rhs_native_mtx_f32,
  ...
  __fallback_quant_nxk_w8cx_f32(n, k, (const float *)rhs_native_mtx_f32,
                                (int8_t *)rhs_native_mtx_w8cx,
                                (float *)rhs_scales_f32);
}

void dequant_w8cx_f32(size_t n, size_t k, void *rhs_native_mtx_w8cx,
                      void *rhs_scales_f32, void *rhs_native_mtx_f32) {
  // w8cx dequant is q * scale per channel, identical to qs8cx: reuse it.
  __fallback_dequant_nxk_qs8cx_f32(n, k, (const int8_t *)rhs_native_mtx_w8cx,
                                   (const float *)rhs_scales_f32,
                                   (float *)rhs_native_mtx_f32);
}
