...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(htp_ops_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(htp_ops_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
