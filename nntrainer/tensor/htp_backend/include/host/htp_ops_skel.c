#ifndef _HTP_OPS_SKEL_H
#define _HTP_OPS_SKEL_H
#include "htp_ops.h"
...
extern "C" {
#endif
_ATTRIBUTE_VISIBILITY uint32_t htp_ops_skel_handle_invoke_qaic_version = 10048;
_ATTRIBUTE_VISIBILITY char htp_ops_skel_handle_invoke_uri[65+1]="file:///libhtp_ops_skel.so?htp_ops_skel_handle_invoke&_modver=1.0";
...
static __inline int _skel_method_2(int (*_pfn)(remote_handle64, int32, int32, int32, int32, int32, int32, int32, int32, int32), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   ...
   _QAIC_ASSERT(_nErr, REMOTE_SCALARS_OUTHANDLES(_sc)==0);
   _QAIC_ASSERT(_nErr, (_pra + ((1 + 0) + (((0 + 0) + 0) + 0))) <= _praEnd);
   _QAIC_ASSERT(_nErr, _pra[0].buf.nLen >= 36);
   _primIn = _pra[0].buf.pv;
   _COPY(_in0, 0, _primIn, 0, 4);
   _COPY(_in1, 0, _primIn, 4, 4);
   _COPY(_in2, 0, _primIn, 8, 4);
   ...
   _COPY(_in7, 0, _primIn, 28, 4);
   _COPY(_in8, 0, _primIn, 32, 4);
   _TRY(_nErr, _pfn(_h, (int32)*_in0, (int32)*_in1, (int32)*_in2, (int32)*_in3, (int32)*_in4, (int32)*_in5, (int32)*_in6, (int32)*_in7, (int32)*_in8));
   _QAIC_CATCH(_nErr) {}
   return _nErr;
}
...
static __inline int _skel_method_4(int (*_pfn)(remote_handle64, int32, uint32), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   ...
   _COPY(_in0, 0, _primIn, 0, 4);
   _COPY(_in1, 0, _primIn, 4, 4);
   _TRY(_nErr, _pfn(_h, (int32)*_in0, (uint32)*_in1));
   _QAIC_CATCH(_nErr) {}
   return _nErr;
}
