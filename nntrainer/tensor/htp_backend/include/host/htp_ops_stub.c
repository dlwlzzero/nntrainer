#ifndef _HTP_OPS_STUB_H
#define _HTP_OPS_STUB_H
#include "htp_ops.h"
#include <string.h>
#ifndef _WIN32
#include "HAP_farf.h"
...
#ifndef _HTP_OPS_SLIM_H
#define _HTP_OPS_SLIM_H
#include <stdint.h>
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(htp_ops_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(htp_ops_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(htp_ops_init_backend)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(htp_ops_create_channel)(remote_handle64 _handle, int32 fd, uint32 size) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_1(_handle, _mid, (uint32_t*)&fd, (uint32_t*)&size);
}
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(htp_ops_destroy_channel)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   return _stub_method(_handle, _mid);
}
static __inline int _stub_method_2(remote_handle64 _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1], uint32_t _in2[1], uint32_t _in3[1], uint32_t _in4[1], uint32_t _in5[1]) {
   remote_arg _pra[1] = {0};
